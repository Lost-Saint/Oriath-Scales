<div class="how-it-works">
	<h2 class="section-title">Quick Price Check Guide</h2>
	<div class="steps">
		<div class="step">
			...
			<div>
				<p class="step-description">
					Press <kbd>Ctrl+C</kbd> while hovering over any item in Path of Exile
				</p>
			</div>
		</div>
		<div class="step">
			...
			<div>
				<p class="step-description">
					Paste the item data into the search box below
				</p>
			</div>
		</div>
		<div class="step">
			...
			<div>
				<p class="step-description">
					Choose whether to include item level in your search results
				</p>
			</div>
		</div>
		<div class="step">
			...
			<div>
				<p class="step-description">
					Click "Search on PoE Trade" to see current market prices
				</p>
			</div>
		</div>
	</div>
